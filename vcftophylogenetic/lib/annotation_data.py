...
class AnnotationData:
    ...
    def _load_gff3_data(self):
        ...
        reference_seq = None
        if self.config['gff3']['reference_seq'] == None:
            reference_seq = self.config['gff3']['reference_seq']

        vcf_file = None
        if self.config['gff3']['vcf_file'] == None:
            reference_seq = self.config['gff3']['vcf_file']


        gff3_attributes = ['ID', key_confidence, 'Parent', 'description', key_ontology , reference_seq,vcf_file ]
