...
class GenotypeData:
    ...
    def get_slice_of_variant_calls(
        ...
        reference_allele = self.callset['variants/REF']
        alternate_alleles =  self.callset['variants/ALT']
        ...
        numbers_of_alternate_alleles = None

        # monoploid / haploid
        if sliced_variant_calls.ndim == 2:
            self.numbers_of_alternate_alleles = allel.HaplotypeArray(sliced_variant_calls).T
        ...
        return SimpleNamespace(**variant_calls_slice)